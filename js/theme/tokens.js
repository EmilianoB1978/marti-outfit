...
export const defaultPreferences = {
  ...
  menuOrder: ["armocromia", "inspirations", "diary", "outfit_history", "reminders", "notes", "budget", "trips", "live", "palette", "dormant", "analytics", "capsules", "calendar", "taxonomies", "settings", "manual", "system"],
  menuHidden: [],
